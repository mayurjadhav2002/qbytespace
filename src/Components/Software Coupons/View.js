    ...
    <div className=" flex flex-col items-center px-5 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col w-full max-w-3xl mx-auto prose text-left prose-blue">
            ...
            <div className="w-full mx-auto">
                ...
                <h1 className='text-5xl font-bold my-2'>A small headline to switch your visitors into users. </h1>
...
<div className="  max-w-7xl md:flex md:items-center md:justify-between ">
  <div className="flex justify-center mb-8 space-x-6 md:order-last md:mb-0">
    <Link  to="https://facebook.com" target='blank' className="text-blue-700 hover:text-blue-800">
    ...
    <Link to="/" target='blank' className="text-cyan-400 hover:text-cyan-500">
