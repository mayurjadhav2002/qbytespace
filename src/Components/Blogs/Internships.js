...
function Internships() {
  const url = process.env.REACT_APP_BASE_BACKEND_URL+"/api/blog/all-blogs";
    ...
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-3 py-4 lg:w-4/5 w-full justify-center mx-auto">
        ...
        <div className="lg:col-span-3 lg:p-5 p-1 ">
          ...
          {data.map((data) => (
            <div className='w-cover p-5 rounded-xl internship-blog m-2 ' key={data._id}>
...
{data.description}
                  ...
                  <div className='lg:hidden xl:block block  xl:w-full xl:ml-4 xl:max-h-28
                ...
                <div className="flex mt-4 h-6 justify-between ">
                  <div className='flex items-center justify-center align-middle'>
                    <p className='text-xs px-2 py-1 mr-2 bg-purple-200 rounded-full text-purple-800 font-semibold'>{data.tags[0]}</p>
                    <p className='text-xs lg:block hidden px-2 py-1 mr-2 bg-purple-200 rounded-full text-purple-800 font-semibold'>{data.tags[1]}</p>
