...
function Blog() {
  ...
  const { blog, loading, error, getData } = BlogAxios(`?id=${id}`);
  const data = blog;
              ...
              <div className=" flex flex-col items-center px-5  mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col w-full max-w-3xl mx-auto prose text-left prose-blue">
                  ...
                  <div className="w-full mx-auto">
                    ...
                    <div className='flex justify-between my-5 items-center'>
                      ...
                      <div className=" items-center max-w-7xl md:flex md:items-center md:justify-between ">
                        <div className="flex items-center justify-center mb-8 space-x-2 md:order-last md:mb-0">
                          ...
                          <Link to="/" target='blank' className="text-pink-400 hover:text-pink-500">
                          ...
                          <Link to="/" target='blank' className="text-gray-400 hover:text-gray-500">
                          ...
                          <Link to="/" target='blank' className="text-blue-800 hover:text-blue-900">
                    ...
                    <figure>
                      <img
                        ...
                        src={'http://localhost:3000/static/Blogs/thumbnail/' + data.thumbnail}

                        alt='http://localhost:3000/static/Blogs/thumbnail/qbytespace-thumbnail-1688669826469GDWP-714-HD-With-Logo.jpg'
                        className='w-full max-h-max py-1'

                      />  <figcaption>Fig.1 - {data.title}</figcaption>
                    </figure>
                  ...
                  <div className='flex items-left'>
                    ...
                    {list?.map(i =>
                      <p className='text-xs px-2 py-1 mr-2 bg-purple-200 rounded-full text-purple-800 font-semibold'>{i}</p>
